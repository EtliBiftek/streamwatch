...
contextBridge.exposeInMainWorld('api', {
  ...
  playerEngineStatus: () => ipcRenderer.invoke('player-engine-status'),
  getPlayerEngineFallback: () => ipcRenderer.invoke('player-engine-last-fallback'),
  onPlayerEngineFallback: (cb) => ipcRenderer.on('player-engine-fallback', (_, value) => cb(value)),
  ...
  liveTools: {
    ...
    closeChat: () => ipcRenderer.invoke('live-tools-chat-close'),
    getChatState: () => ipcRenderer.invoke('live-tools-chat-state'),
    onChatState: (cb) => ipcRenderer.on('live-tools-chat-state', (_, value) => cb(value)),
  },
  features: {
